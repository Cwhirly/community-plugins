...
# tools/lunar-calendar/generate_data.py -> repository root
REPO = pathlib.Path(__file__).resolve().parents[2]
PLUGIN = REPO / "lunar-calendar"
FIXTURES = REPO / "fixtures" / "lunar-calendar"
...
def main():
    ...
    lines.append("-- Generated by tools/generate_data.py in this directory - DO NOT EDIT BY HAND.")
    ...
    target = FIXTURES / "reference.luau"
    target.write_text("\n".join(lines), encoding="utf-8")
    print(f"# wrote {target.relative_to(REPO)} with {len(samples)} days")
